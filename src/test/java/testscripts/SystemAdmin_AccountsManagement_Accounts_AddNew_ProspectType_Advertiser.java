...
public class SystemAdmin_AccountsManagement_Accounts_AddNew_ProspectType_Advertiser extends BaseTest {
	...
	public void editAccount() throws Exception {
		...
		// Navigation to login page
				...
				objectlistpage.assertFieldLabelAndValue("Shipping Address", "555 Mission Rock Street\nSan Francisco, California 94158\nUnited States");
				...
				driver.findElement(By.xpath("//div[contains(@class, 'active')]//div[normalize-space()='Advertiser Type']/parent::div//span[normalize-space()='Available']/following-sibling::div//li[@role='presentation']//span/span[normalize-space()='Local']")).click();                     
